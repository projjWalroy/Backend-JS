...
const bot = new Telegraf('6125008378:AAGWE37_jL6GSK8ZlblbD6eMh4ecIg9IEpc');

bot.start((ctx) => ctx.reply('Welcome to the new coding bot from projjwal'));

//bot.command('binarysearchjs' , (ctx) => ctx.reply(binarysearch));
bot.command('whomadethis', (ctx) => ctx.reply('projjwal'));
